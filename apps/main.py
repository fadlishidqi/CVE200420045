...
def main():
    ...
    pathSource = [
        "apps/data/raw/ISD OPR_AHMMO 06-03-2026 23.11.55.json",
        "apps/data/raw/ISD OPR_AHMMO 11-03-2026 14.27.23.json",
        "apps/data/raw/ISD OPR_AHMMO 13-12-2025 00.03.16.json",
        "apps/data/raw/ISD OPR_AHMMO 21-01-2026 05.25.09.json",
    ]
    ...
    pathTarget_final = "apps/data/result/ISD OPR_AHMMO RAW.json"
